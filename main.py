...
if __name__ == '__main__':
    ...
    parser.add_argument('--c_dim', type=int, default=8, help='dimension of domain labels (RaFD)')
    ...
    parser.add_argument('--num_iters_decay', type=int, default=100000, help='iterations to decay lr')
